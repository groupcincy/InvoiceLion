...
$results = array(
    ...
    'Hours: hours.vat_percentage = invoicelines.vat_percentage'=>DB::selectValues('select hours.id from hours, invoicelines where hours.tenant_id=? and hours.invoiceline_id = invoicelines.id and hours.vat_percentage <> invoicelines.vat_percentage', $_SESSION['user']['tenant_id']),
