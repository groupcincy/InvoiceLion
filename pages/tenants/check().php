...
$results = array(
    'Hours: hours worked * hourly fee = subtotal'=>DB::selectValues('select id from hours where tenant_id=? and round(hours_worked * hourly_fee) <> round(subtotal)', $_SESSION['user']['tenant_id']),
