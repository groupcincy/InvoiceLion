...
$results = array(
    'Hours: hours worked * hourly fee = subtotal'=>DB::selectValues('select id from hours where tenant_id=? and ABS(subtotal - (hours_worked * hourly_fee))<1', $_SESSION['user']['tenant_id']),
