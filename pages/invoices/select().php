<?php 
$hours_customer_ids = DB::selectValues('select distinct customer_id from hours where invoiceline_id IS NULL AND hourly_fee IS NOT NULL AND customer_id IS NOT NULL AND `tenant_id` = ?', $_SESSION['user']['tenant_id']);
